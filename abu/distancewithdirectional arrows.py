...
try:
    while True:
        ...
        if nearest_object:
            ...
            # Determine navigation arrows
            if obj_center_x < center_x - 50:
                cv2.arrowedLine(color_image, (center_x, center_y), (center_x - 50, center_y), (0, 0, 255), 2)
            elif obj_center_x > center_x + 50:
                cv2.arrowedLine(color_image, (center_x, center_y), (center_x + 50, center_y), (0, 0, 255), 2)
            
            if obj_center_y < center_y - 50:
                cv2.arrowedLine(color_image, (center_x, center_y), (center_x, center_y - 50), (0, 0, 255), 2)
